...
<div class="container">
      ...
      <div class="media js-html-inspector" data-replace-target="> div">
        ...
        <div class="media-left media-middle">
          <div class="h2"> .h2 <small>small</small> </div>
        </div>
        <div class="media-left media-middle">
          <h3> h3 <small>small</small> </h3>
        </div>
        <div class="media-left media-middle">
          <div class="h4"> .h4 <small>small</small> </div>
        </div>
        <div class="media-left media-middle">
          <h5> h5 <small>small</small> </h5>
        </div>
        <div class="media-left media-middle">
          <div class="h6"> .h6 <small>small</small> </div>
        </div>
      </div>
      <div class="row js-html-inspector" data-replace-target="> div" data-remove-target="br">
        ...
        <div class="col-sm-2 col-xs-4">
          ...
          <span class="small">.small</span> </div>
        <div class="col-sm-2 col-xs-4">
          <!-- Italics -->
          <em>em</em><br>
          <i>i (italic)</i> </div>
      ...
      <div class="js-html-inspector"> <span class="text-lowercase">.text-lowercase</span> <span class="text-uppercase">.text-uppercase</span> <span class="text-capitalize">.text-capitalize</span> </div>
      <br>

      <!-- Abbreviations -->
      <div class="js-html-inspector"> <abbr title="abbreviation">abbr</abbr> <abbr class="initialism" title="abbreviation.initialism"> .initialism </abbr> </div>
      <br>
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <form>
          ...
          <div class="form-group">
            ...
            <span class="help-block"> .help-block: Wrap labels and controls in <code>.form-group</code> for optimum spacing. </span> </div>
      ...
      <div class="js-html-inspector" data-remove-target='["p:not([class])","br"]'>
        ...
        <form class="form-horizontal">
          <div class="form-group">
            <label class="col-sm-3 control-label" for="example-text-input-horizontal"> label.control-label </label>
            <div class="col-sm-9">
              <input class="form-control" id="example-text-input-horizontal" type="text" placeholder="input.form-control">
            </div>
          </div>
          <div class="form-group form-group-lg">
            <label class="col-sm-3 control-label" for="example-text-input-horizontal-lg"> label.control-label </label>
            <div class="col-sm-9">
          ...
          <div class="form-group form-group-sm">
            <label class="col-sm-3 control-label" for="example-text-input-horizontal-sm"> label.control-label </label>
            <div class="col-sm-9">
          ...
          <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9">
              <label class="checkbox-inline">
                ...
                label.checkbox-inline Checkbox #1 </label>
              <label class="checkbox-inline">
                <input type="checkbox" value="option2">
                Checkbox #2 </label>
              <label class="checkbox-inline disabled">
                <input type="checkbox" value="option3" disabled>
                Disabled checkbox #3 </label>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9">
              <label class="radio-inline">
                ...
                label.radio-inline Radio #1 </label>
              <label class="radio-inline">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5"> <br class="visible-xs">
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <form class="form-horizontal">
          ...
          <div class="form-group has-success">
            <label class="col-sm-3 control-label" for="input-success"> .has-success </label>
            <div class="col-sm-9">
              <input class="form-control" id="input-success" type="text" placeholder="input.form-control">
            </div>
          </div>
          <div class="form-group has-success has-feedback">
            <label class="col-sm-3 control-label" for="input-success-2"> .has-feedback </label>
            <div class="col-sm-9">
          ...
          <div class="form-group has-warning">
            <label class="col-sm-3 control-label" for="input-warning"> .has-warning </label>
            <div class="col-sm-9">
              <input class="form-control" id="input-warning" type="text" placeholder="input.form-control">
            </div>
          </div>
          <div class="form-group has-warning has-feedback">
            <label class="col-sm-3 control-label" for="input-warning-2"> .has-feedback </label>
            <div class="col-sm-9">
          ...
          <div class="form-group has-error">
            <label class="col-sm-3 control-label" for="input-error"> .has-error </label>
            <div class="col-sm-9">
              <input class="form-control" id="input-error" type="text" placeholder="input.form-control">
            </div>
          </div>
          <div class="form-group has-error has-feedback">
            <label class="col-sm-3 control-label" for="input-error-2"> .has-feedback </label>
            <div class="col-sm-9">
      ...
      <!-- Button tags -->
      <p class="bse-buttons js-html-inspector"> <a class="btn btn-default" href="#">a</a>
      ...
      <div class="row bs-thumbnails js-html-inspector" data-remove-target="p" data-replace-target="> div">
        <div class="col-sm-3 col-xs-6">
          ...
          <img class="img-rounded" src="data:image/svg+xml;base64," alt=".img-rounded"> </div>
        <div class="col-sm-3 col-xs-6">
          <p><strong>.img-circle</strong></p>
          <img class="img-circle" src="data:image/svg+xml;base64," alt=".img-circle"> </div>
        <div class="col-sm-3 col-xs-6">
          <p><strong>.img-thumbnail</strong></p>
          <img class="img-thumbnail" src="data:image/svg+xml;base64," alt=".img-thumbnail"> </div>
        <div class="col-sm-3 col-xs-6">
          <p><strong>.img-responsive</strong></p>
          <img class="img-responsive" src="data:image/svg+xml;base64," alt=".img-responsive"> </div>
      </div>
      <h2 id="helper-classes">Helper classes</h2>
      <!-- Contextual colors -->
      <p class="js-html-inspector"> <span class="text-muted">.text-muted</span> <span class="text-primary">.text-primary</span> <span class="text-success">.text-success</span> <span class="text-info">.text-info</span> <span class="text-warning">.text-warning</span> <span class="text-danger">.text-danger</span> </p>

      <!-- Contextual backgrounds -->
      <p class="js-html-inspector"> <span class="bg-primary">.bg-primary</span> <span class="bg-success">.bg-success</span> <span class="bg-info">.bg-info</span> <span class="bg-warning">.bg-warning</span> <span class="bg-danger">.bg-danger</span> </p>

      <!-- Close icon -->
      <p class="js-html-inspector"> button.close &rarr;
      ...
      <p>
        <!-- Image replacement -->
        <code>.text-hide</code>: Replace an element's text content with a background image. </p>
      <h1 class="page-header" id="components">Components</h1>
      <h2 id="glyphicons">Glyphicons</h2>
      <p> <a href="http://glyphicons.com/" target="_blank">Glyphicons</a> classes: <code>glyphicon glyphicon-*</code> </p>
      ...
      <div class="btn-toolbar bse-buttons js-html-inspector">
        ...
        <div class="btn-group">
          ...
          <button class="btn btn-default" type="button">#2</button>
          <div class="btn-group">
            <button class="btn btn-default dropdown-toggle" data-toggle="dropdown" type="button"> button.dropdown-toggle <span class="caret"></span> </button>
        ...
        <div class="btn-group-vertical">
          ...
          <div class="btn-group">
            <button class="btn btn-default dropdown-toggle" data-toggle="dropdown" type="button"> Dropdown <span class="caret"></span> </button>
            <ul class="dropdown-menu">
              <li><a href="#">Link #1</a></li>
              <li><a href="#">Link #2</a></li>
            </ul>
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <div class="btn-group btn-group-justified"> <a href="#" class="btn btn-default">#1</a> <a href="#" class="btn btn-default">#2</a> <a href="#" class="btn btn-default">#3</a> </div>
      </div>
      <br>
      <div class="js-html-inspector" data-remove-target="p:first" data-remove-class-target="div.bse-buttons">
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <div class="form-group">
          <div class="input-group"> <span class="input-group-addon">.input-group-addon</span>
            <input class="form-control" type="text" placeholder="input.form-control">
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <div class="form-group">
          <div class="input-group input-group-lg"> <span class="input-group-addon">Addon</span>
            <input class="form-control input-lg" type="text" placeholder=".input-lg">
            <span class="input-group-addon">Addon</span> </div>
        </div>
      </div>
      <div class="js-html-inspector" data-remove-target="p:first">
        <p><strong>.input-group-sm</strong></p>
        <div class="form-group">
          <div class="input-group input-group-sm"> <span class="input-group-addon">Addon</span>
            <input class="form-control input-sm" type="text" placeholder=".input-sm">
            <span class="input-group-addon">Addon</span> </div>
        </div>
      </div>
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <ul class="nav nav-tabs">
          ...
          <li class="disabled"> <a href="#">li.disabled a</a> </li>
          <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"> li.dropdown <span class="caret"></span> </a>
            <ul class="dropdown-menu dropdown-menu-right">
              <li><a href="#">Link #1</a></li>
              <li><a href="#">Link #2</a></li>
            </ul>
      ...
      <div class="js-html-inspector" data-remove-target='["p:first","br"]'> <br>
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="navbar-header"> <a class="navbar-brand" href="#">.navbar-header .navbar-brand</a> </div>
            <ul class="nav navbar-nav">
              <li class="active"> <a href="#">ul.nav.navbar-nav li.active a</a> </li>
              <li><a href="#">Link #2</a></li>
            </ul>
          </div>
        </nav>
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <nav class="navbar navbar-inverse">
          <div class="container-fluid">
            ...
            <p class="navbar-text"> p.navbar-text <a href="#" class="navbar-link">a.navbar-link</a> </p>
        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            <div class="navbar-header">
              <button class="navbar-toggle" data-toggle="collapse" data-target="#navbar-collapse-2" type="button"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-2">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"> .navbar-right Dropdown <b class="caret"></b> </a>
                  <ul class="dropdown-menu">
                    <li><a href="#">Link #1</a></li>
                    <li><a href="#">Link #2</a></li>
                  </ul>
      ...
      <p class="js-html-inspector" data-remove-target="p:first"> <span class="label label-default">.label.label-default</span> <span class="label label-primary">.label.label-primary</span> <span class="label label-success">.label.label-success</span> <span class="label label-info">.label.label-info</span> <span class="label label-warning">.label.label-warning</span> <span class="label label-danger">.label.label-danger</span> </p>
      ...
      <div class="row">
        <div class="col-sm-3 col-xs-6 js-html-inspector" data-remove-target="p:first">
          ...
          <div class="thumbnail"> <img style="width: 100%" src="data:image/svg+xml;base64," alt="thumbnail">
            <div class="caption">
              <h3>.caption h3</h3>
              <p>Paragraph</p>
      ...
      <div class="row js-html-inspector" data-replace-target="> div">
        <div class="col-sm-6">
          <div class="alert alert-success"> .alert.alert-success <a class="alert-link" href="#">a.alert-link</a> </div>
        </div>
        <div class="col-sm-6">
          <div class="alert alert-info"> .alert.alert-info <a class="alert-link" href="#">a.alert-link</a> </div>
        </div>
        <div class="col-sm-6">
          <div class="alert alert-warning"> .alert.alert-warning <a class="alert-link" href="#">a.alert-link</a> </div>
        </div>
        <div class="col-sm-6">
          <div class="alert alert-danger"> .alert.alert-danger <a class="alert-link" href="#">a.alert-link</a> </div>
        </div>
      </div>
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <div class="progress">
          <div class="progress-bar" style="width: 80%;"> <span>.progress-bar</span> </div>
        </div>
        <div class="progress">
          <div class="progress-bar progress-bar-success" style="width: 80%;"> <span>.progress-bar.progress-bar-success</span> </div>
        </div>
        <div class="progress">
          <div class="progress-bar progress-bar-info" style="width: 80%;"> <span>.progress-bar.progress-bar-info</span> </div>
        </div>
        <div class="progress">
          <div class="progress-bar progress-bar-warning" style="width: 80%;"> <span>.progress-bar.progress-bar-warning</span> </div>
        </div>
        <div class="progress">
          <div class="progress-bar progress-bar-danger" style="width: 80%;"> <span>.progress-bar.progress-bar-danger</span> </div>
        </div>
      </div>
      <div class="js-html-inspector" data-remove-target="p:first">
      ...
      <div class="js-html-inspector" data-remove-target="strong:first"> <strong>.media</strong>
        <div class="media"> <a class="media-left" href="#"> <img class="media-object" src="data:image/svg+xml;base64," alt=".media-object"> </a>
          <div class="media-body">
            <h4 class="media-heading">.media-body h4.media-heading</h4>
            &larr; a.media-left img.media-object </div>
        </div>
      </div>
      <br>
      <div class="js-html-inspector" data-remove-target="p:first"> <strong>.media</strong>
        <div class="media"> <a class="media-left media-middle" href="#"> <img class="media-object" src="data:image/svg+xml;base64," alt=".media-object"> </a>
          <div class="media-body">
            <h4 class="media-heading">.media-body h4.media-heading</h4>
      ...
      <br>
      <div class="js-html-inspector" data-remove-target="p:first"> <strong>ul.media-list</strong>
        <ul class="media-list">
          <li class="media"> <a class="media-left media-bottom" href="#"> <img class="media-object" src="data:image/svg+xml;base64," alt=".media-object"> </a>
            <div class="media-body">
          ...
          <li class="media">
            <div class="media-body">
              <h4 class="media-heading">li.media .media-body h4.media-heading</h4>
              a.media-right img.media-object &rarr; </div>
            <a class="media-right" href="#"> <img class="media-object" src="data:image/svg+xml;base64," alt=".media-object"> </a> </li>
        </ul>
      </div>
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item"> List item #2 <span class="badge">.badge</span> </li>
      ...
      <div class="row">
        <div class="col-md-6 js-html-inspector" data-remove-target="p:first">
          ...
          <div class="list-group"> <a class="list-group-item" href="#"> a.list-group-item </a> <a class="list-group-item list-group-item-success" href="#"> a.list-group-item.list-group-item-success </a> <a class="list-group-item list-group-item-info" href="#"> a.list-group-item.list-group-item-info </a> <a class="list-group-item list-group-item-warning" href="#"> a.list-group-item.list-group-item-warning </a> <a class="list-group-item list-group-item-danger" href="#"> a.list-group-item.list-group-item-danger </a> </div>
        </div>
        <div class="col-md-6 js-html-inspector" data-remove-target="p:first">
          <p><strong>div.list-group</strong></p>
          <div class="list-group"> <a class="list-group-item active" href="#"> a.list-group-item.active </a> <a class="list-group-item list-group-item-success active" href="#"> a.list-group-item.list-group-item-success.active </a> <a class="list-group-item list-group-item-info active" href="#"> a.list-group-item.list-group-item-info.active </a> <a class="list-group-item list-group-item-warning active" href="#"> a.list-group-item.list-group-item-warning.active </a> <a class="list-group-item list-group-item-danger active" href="#"> a.list-group-item.list-group-item-danger.active </a> </div>
        </div>
      </div>
      <div class="js-html-inspector" data-remove-target="p:first">
        <p><strong>div.list-group</strong></p>
      ...
      <p class="bse-buttons"> Via data attributes: <code>data-toggle="modal"</code> <code>data-target="#modal"</code> <a class="btn btn-primary" data-toggle="modal" href="#modal">Launch modal</a> </p>
      <p class="bse-buttons"> Via Javascript: <code>$('#modal').modal()</code> <a class="btn btn-primary" href="#" onclick="$('#modal').modal(); return false;">Launch modal</a> </p>
      <div> <a class="btn btn-primary" data-toggle="modal" href="#modal-lg">Large modal</a> <a class="btn btn-primary" data-toggle="modal" href="#modal-sm">Small modal</a> </div>
        ...
        <div class="modal" style="display: block; position: static; overflow: hidden;">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer"> <span>.modal-footer</span>
      ...
      <div class="js-html-inspector">
        <div class="dropdown"> <a class="btn btn-primary" data-toggle="dropdown" href="#"> Dropdown trigger </a>
          <ul class="dropdown-menu">
            <li><a href="#">Link #1</a></li>
            <li><a href="#">Link #2</a></li>
          </ul>
      ...
      <p><br>
        Via Javascript: <code>$('.dropdown-toggle').dropdown()</code>(<code>data-toggle="dropdown"</code> still required)</p>
      ...
      <div class="js-html-inspector">
        <ul class="nav nav-tabs">
          <li class="active"> <a data-toggle="tab" href="#js-tab-pane1">Tab #1</a> </li>
          <li> <a data-toggle="tab" href="#js-tab-pane2">Tab #2</a> </li>
        </ul>
      ...
      <div class="js-html-inspector">
        <ul class="nav nav-tabs">
          <li class="active"> <a href="#js-tab-pane3" onclick="$(this).tab('show'); return false;">Tab #1</a> </li>
          <li> <a href="#js-tab-pane4" onclick="$(this).tab('show'); return false;">Tab #2</a> </li>
        </ul>
        <div class="tab-content">
      ...
      <div class="text-center js-html-inspector">
        <button class="btn btn-primary" data-toggle="tooltip" data-placement="left" type="button" title="[title]"> Left </button>
        <button class="btn btn-primary" data-toggle="tooltip" data-placement="top" type="button" title="[title]"> Top </button>
        <button class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" type="button" title="[title]"> Bottom </button>
        <button class="btn btn-primary" data-toggle="tooltip" data-placement="right" type="button" title="[title]"> Right </button>
      </div>
      <div class="text-center js-html-inspector">
        <!-- Static tooltip -->
      ...
      <p> Options: <code>animation: true|false</code> <code>html: false|true</code> <code>selector: false|string</code><br>
      ...
      <div class="text-center js-html-inspector">
        <button class="btn btn-primary" data-toggle="popover" data-placement="left" data-content="[data-content]" type="button" title="[title]"> Left </button>
        <button class="btn btn-primary" data-toggle="popover" data-placement="top" data-content="[data-content]" type="button" title="[title]"> Top </button>
        <button class="btn btn-primary" data-toggle="popover" data-placement="bottom" data-content="[data-content]" type="button" title="[title]"> Bottom </button>
        <button class="btn btn-primary" data-toggle="popover" data-placement="right" data-content="[data-content]" type="button" title="[title]"> Right </button>
      </div>
      <div class="text-center js-html-inspector">
        <!-- Static popover -->
      ...
      <div class="js-html-inspector">
        <div class="alert alert-danger fade in">
          <button class="close" data-dismiss="alert" type="button">&times;</button>
          .alert.alert-danger.fade.in </div>
      </div>
      ...
      <div class="bse-buttons js-html-inspector">
        <button class="btn btn-primary" id="stateful" data-loading-text="Loading..." data-complete-text="Completed" type="button" onclick="$(this).button('loading').siblings().prop('disabled', false);"> $('#stateful').button('loading') </button>
        <button class="btn btn-primary" type="button" onclick="$(this).prop('disabled', true); $('#stateful').button('complete');" disabled> $('#stateful').button('complete') </button>
        <button class="btn btn-primary" type="button" onclick="$('#stateful').button('reset').siblings().prop('disabled', true);" disabled> $('#stateful').button('reset') </button>
      </div>
      <br>
      <div class="js-html-inspector"> Single toggle:
        <button class="btn btn-primary" data-toggle="button" type="button"> [data-toggle="button"] </button>
      </div>
      <br>
      <div class="bse-buttons js-html-inspector"> Checkbox: <code>data-toggle="buttons"</code>
      ...
      <br>
      <div class="bse-buttons js-html-inspector"> Radio: <code>data-toggle="buttons"</code>
        <div class="btn-group" data-toggle="buttons">
          <label class="btn btn-primary">
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <div class="panel-group" id="accordion">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse-1"> data-toggle="collapse" data-parent="#accordion" href="#collapse-1" </a> </h4>
            </div>
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse-2"> data-toggle="collapse" data-parent="#accordion" href="#collapse-2" </a> </h4>
            </div>
      ...
      <div class="js-html-inspector" data-remove-target="p:first">
        ...
        <div class="carousel slide" id="carousel">
          ...
          <!-- Controls -->
          <a class="left carousel-control" data-slide="prev" href="#carousel"> <span class="icon-prev"></span> </a> <a class="right carousel-control" data-slide="next" href="#carousel"> <span class="icon-next"></span> </a> </div>
      </div>
      <br>
